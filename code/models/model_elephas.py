...
def Sleep_Conv_Net(num_classes=5, 
    ...
    input_layer = layers.Input(shape=(9000,))
    input_layer_reshaped = layers.Reshape((3,3000), input_shape=(9000,))(input_layer)
    input_layer_reshaped = layers.Permute((2,1))(input_layer_reshaped)
    
    x1 = small_cnn(input_layer_reshaped)
    x2 = large_cnn(input_layer_reshaped) 
    ...
    x = transformer(features, head_size, heads, dim_feed_forw, attention_dropout)
